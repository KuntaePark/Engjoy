    ...
    void FixedUpdate()
    {
        ...
        foreach (var kv in serverPositions)
        {
            ...
            if (!players.ContainsKey(playerId))
            {
                ...
                LobbyPlayerController playerController = newPlayer.GetComponent<LobbyPlayerController>();
            ...
            else
            {
                ...
                LobbyPlayerController playerController = players[playerId].GetComponent<LobbyPlayerController>();
